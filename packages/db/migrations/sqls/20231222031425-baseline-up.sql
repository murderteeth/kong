...
-------------
--- MIGRATION 4
ALTER TABLE vault ADD COLUMN deposit_limit numeric NULL;
...
-------------
--- MIGRATION 5
ALTER TABLE tvl ADD COLUMN price_source text NOT NULL DEFAULT 'unknown';
UPDATE tvl SET price_source = 'lens';
