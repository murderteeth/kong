  ...
  WITH withdrawal_queue_agg AS (
    SELECT
      ...
      json_agg(json_build_object(
        ...
        'netApr', s.net_apr,
        'estimatedTotalAssets', s.estimated_total_assets,
        'delegatedAssets', s.delegated_assets,
        'assetAddress', s.asset_address,
        'performanceFee', s.performance_fee,
        'debtRatio', s.debt_ratio,
        'minDebtPerHarvest', s.min_debt_per_harvest,
        'maxDebtPerHarvest', s.max_debt_per_harvest,
        'lastReportBlockTime', s.last_report_block_time,
        'totalDebt', s.total_debt,
        'totalDebtUsd', s.total_debt_usd,
        'totalGain', s.total_gain,
