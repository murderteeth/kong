...
describe('db', function() {
  it('gets v2 vault api version', async function() {
    const vault = {
      chainId: mainnet.id, address: addresses.v2.yvweth, asOfBlockNumber: 0n,
      apiVersion: '0.4.2'
    } as types.Vault
  ...
  it('gets v2 strategy api version', async function() {
    const strategy = {
      chainId: mainnet.id, address: addresses.v2.strategyLenderYieldOptimiser, asOfBlockNumber: 0n,
      apiVersion: '0.3.2'
    } as types.Vault
  ...
  it('gets v3 strategy api version', async function() {
    const strategy = {
      chainId: polygon.id, address: addresses.v3.aaveV3UsdcLender, asOfBlockNumber: 0n,
