...
describe('prices', function() {
  ...
  it('returns oracle price for WETH', async function() {
    const { source, price } = await fetchErc20PriceUsd(this.rpc, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', this.block)
  ...
  it('returns magic price for yvCurve-clevCVX-f-f', async function() {
    const { source, price } = await fetchErc20PriceUsd(this.rpc, '0xc869206adAfD3D874dB22e8BbA662E05F6257613', this.block)
    console.log(this.block, source, price)
