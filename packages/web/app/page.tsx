...
export default function Home() {
  return <main className="relative w-full min-h-screen sm:h-screen flex justify-center">
    <Filler className="hidden sm:block fixed -z-[1] w-[30%] h-screen top-0 left-0 text-emerald-900" />
    ...
    <Filler className="hidden sm:block fixed -z-[1] w-[30%] h-screen top-0 right-0 text-emerald-900" />
  </main>
}
